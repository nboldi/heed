...
exportMonoLiteral (L l lit@(HsInt _ _)) = exportError "literal" lit -- generated by GHC
exportMonoLiteral (L l lit@(HsInteger _ _ _)) = exportError "literal" lit -- generated by GHC
exportMonoLiteral (L l lit@(HsRat _ i)) = exportError "literal" lit -- generated by GHC
