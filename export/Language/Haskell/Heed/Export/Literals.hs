...
exportMonoLiteral (L l lit@(HsInt _ _)) = return () -- generated by GHC
exportMonoLiteral (L l lit@(HsInteger _ _ _)) = return () -- generated by GHC
exportMonoLiteral (L l lit@(HsRat _ i)) = return () -- generated by GHC
